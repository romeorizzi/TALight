...
def validation(sequence):
    ...
    if final_sequence == new_sequence:
        ...
        print("Risultato errato: il risultato finale dovrebbe essere la sequenza binaria iniziale con un 1 alla fine se è presente almeno un 1 nella sequenza, altrimenti uno 0\n")
...
print("\nProblema: scrivere le istruzioni per una macchina di Turing che,\ndata una sequenza di caratteri binaria,\nscorre tutta la sequenza e aggiunge un 1 alla fine della stringa se è presente almeno un 1,\naltrimenti aggiunge uno 0")
