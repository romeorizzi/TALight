...
if ENV['print_sol']:
  sheets, sol = cl.calculate_sheets(instance['rainbow'], ENV['print_sol'])
else:
  sheets = cl.calculate_sheets(instance['rainbow'], ENV['print_sol'])
...
if ENV['print_sol']:
  sol_arr = sol.split('\n')
  TAc.print(LANG.render_feedback("print-sol", f'Here is the graphical solution:'), "green", ["bold"])
  
  for linea in reversed(sol_arr):
    TAc.print(f'{linea}', "white", ["bold"])
  print()
