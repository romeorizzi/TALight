...
if TALf.exists_input_file('instance'):
    ...
    if ENV["source"] == 'randgen_1':
        ...
        TAc.print(LANG.render_feedback("instance-randgen1-successful", f'The instance has been successfully generated by the pseudo-random generator {ENV["source"]} called with arguments:\n   seed={ENV["seed"]}\n   m={ENV["m"]}\n   n={ENV["n"]}\n   alphabet={ENV["alphabet"]}'), "yellow", ["bold"])
    elif ENV["source"] == 'randgen_2':
        instance = ll.instance_randgen_2(ENV["m"], ENV["n"], ENV["opt_val"], ENV["alphabet"], ENV["seed"])
        TAc.print(LANG.render_feedback("instance-randgen2-successful", f'The instance has been successfully generated by the pseudo-random generator {ENV["source"]} called with arguments:\n   seed={ENV["seed"]}\n   m={ENV["m"]}\n   n={ENV["n"]}\n   opt_val={ENV["opt_val"]}\n   alphabet={ENV["alphabet"]}'), "yellow", ["bold"])
    else:
        assert False
