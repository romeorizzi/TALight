...
rtal connect model_lcs try_GMPL_model -adisplay_output=1 -adisplay_error=1 -adisplay_solution=1 -acheck_solution=1 -asol_style=subsequence -ainstance_id=6 -- bots/TA_send_files_bot.py mod=models/lcs_ILP-model-gmpl.mod
