...
for line in gen_lines:
    ...
    if line[:len(keyword)] == keyword:
        ...
        rel_path_src = path.relpath(target_abs_fullpath, WHOLECATALOGUE_SUBFOLDER_FULLNAME)
        symlink(rel_path_src, path.join(WHOLECATALOGUE_SUBFOLDER_FULLNAME,target_filename))
