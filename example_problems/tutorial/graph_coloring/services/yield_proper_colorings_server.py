    ...
    if buffer[0] == '(':
        ...
        if len(set(colors)) > colorsNum:
            ...
            if result:
                ...
                TAc.print(LANG.render_feedback("wrong-colors-subgraph", f"NO! The graph is not {colorsNum}-colorable so you have to insert the minimal uncolorable induced subgraph"), "red", ["bold"])
                print()