...
service="easy_lemma_3col_from_gen_graph_to_4regular_graph"
args_list = [
    ('num_nodes',int),
    ('seed',str),
    ('lang',str),    
...
newAdjacencyMatrix = nx.adjacency_matrix(newGraph)
newAdjacencyMatrix = newAdjacencyMatrix.todense().tolist()
