...
eul = ENV['eulerian']
walktype = ENV['walk_type']

if (walktype == "closed" or walktype == "any"):
...
if (walktype == "open" or walktype == "any"):
    answer1 = g.isEulerianCycle()
    answer2 = g.isValidNextEdge(head, tail)
    if (answer2 == eul and answer1==False):
        TAc.OK()
        if answer2 == True:
