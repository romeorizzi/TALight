...
if internet[1] == 0:
  if internet[0]!=Ip[0] or (Ip[1]>255 or Ip[1]<0) or (Ip[2]>255 or Ip[2]<0)  or (Ip[3]>255 or Ip[3]<0) :
    TAc.print("ERRORE\nRiprova", "red", ["bold"])
  else:
      TAc.print("GIUSTO\n", "green", ["bold"]) 
elif internet[1] != 0 and internet[2]==0:
  if internet[0]!=Ip[0] or internet[1]!=Ip[1] or (Ip[2]>255 or Ip[2]<0)  or (Ip[3]>255 or Ip[3]<0) :
    TAc.print("ERRORE\nRiprova", "red", ["bold"])
  else:
      TAc.print("GIUSTO\n", "green", ["bold"])
else:
  if internet[0]!=Ip[0] or internet[1]!=Ip[1] or internet[2]!=Ip[2]  or (Ip[3]>255 or Ip[3]<0) :
    TAc.print("ERRORE\nRiprova", "red", ["bold"])
  else:
      TAc.print("GIUSTO\n", "green", ["bold"])
