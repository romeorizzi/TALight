...
rtal connect model_lcs gimme_instance -ainstance_spec=catalogue1 -ainstance_id=2 -am=5 -an=5 -aalphabet=dna -aformat=only_strings.txt
rtal connect model_lcs gimme_instance -ainstance_spec=catalogue1 -ainstance_id=2 -am=5 -an=5 -aalphabet=dna -aformat=with_m_and_n.txt
rtal connect model_lcs gimme_instance -ainstance_spec=catalogue1 -ainstance_id=2 -am=5 -an=5 -aalphabet=dna -aformat=dat
