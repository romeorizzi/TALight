...
args_list = [
    ...
    ('name_of_opt_val',str),
    ('name_of_opt_sol',str),
    ('name_of_num_MSTs',str),
    ('name_of_list_MSTs',str),
...
def verif_one_MST(nodi:List[str],archi:List[Tuple[str,str,int]],archi:List[Tuple[str,str,int]],archi_proibiti:List[Tuple[str,str,int]],archi_obbligati:List[Tuple[str,str,int]], answer:Dict, pt_tot:int,pt_formato_OK:int,pt_feasibility_OK:int,task_number):
    feedback_summary = ""
    elementi=[]
    pesi=[]
    valori=[]
...
feedback_dict = verif_one_MST(ENV["task"],ENV["elementi"],ENV["pesi"],ENV["valori"],ENV["Knapsack_Capacity"], \
