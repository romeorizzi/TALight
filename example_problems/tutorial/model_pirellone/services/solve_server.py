...
if TALf.exists_input_file('instance'):
    ...
    instance, solution1 = pl.gen_instance(ENV['m'], ENV['n'], ENV['seed'], with_yes_certificate=True)
    if solution1!='NO SOLUTION':
        solution=pl.make_optimal(solution1)
    else:
        solution=solution1
    instance_str = pl.instance_to_str(instance, instance_format=ENV['instance_format'])
    output_filename = f"instance_{ENV['m']}_{ENV['n']}_{ENV['seed']}.{extension}"
    ...
    output_filename = f"instance_catalogue_{ENV['instance_id']}.{extension}"
