...
if TALf.exists_input_file('instance'):
    ...
    instance, certificate= pl.gen_instance(4, 4, ENV['seed'], with_yes_certificate=True)
    # instance= pl.gen_instance(ENV['m'], ENV['n'], ENV['seed'])
    solution=pl.make_optimal(certificate) if pl.is_solvable_seed(ENV['seed']) else pl.NO_SOL
