/* An instance (in txt format) generator for the pirellone problem
   Usage:
   ./instance-pirellone.cpp <M> <N> <solvable> <seed>
   where
...
void usage() {
  printf("This program is an instance (in txt format) generator for the Pirellone problem.\n");
  printf(" Usage:\n");
  printf("   ./instance-pirellone <M> <N> <solvable> <seed>\n");
  printf("   where:\n");
