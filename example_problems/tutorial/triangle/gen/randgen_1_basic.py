...
def main(n, m, MIN_VAL, MAX_VAL, MIN_VAL_BIG, MAX_VAL_BIG, seed, big_seed, path, file_full_extension):
    # Automatic cast:
    n = int(n)
    m = int(m)
    MIN_VAL = int(MIN_VAL)
    ...
    instance = tl.instances_generator(1, 1, MIN_VAL, MAX_VAL, n, n, m, m, MIN_VAL_BIG, MAX_VAL_BIG, seed, big_seed, path)[0]
