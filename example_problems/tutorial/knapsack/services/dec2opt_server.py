...
if ENV['goal'] == "correct":
    if answer == True:
        if prompt == "y":
            TAc.print(LANG.render_feedback("ok-Truecorrect-dec2opt", "Corretto!"),"green")
        if prompt == "n":
            TAc.print(LANG.render_feedback("no-Truecorrect-dec2opt", "Sbagliato!"),"red")
    if answer == False:
        if prompt == "y":
            TAc.print(LANG.render_feedback("no-Falsecorrect-dec2opt", "Sbagliato!"),"red")
        if prompt == "n":
            TAc.print(LANG.render_feedback("ok-Falsecorrect-dec2opt", "Corretto!"),"green") 
...
if ENV['goal'] == "at_most_one_call":
    if answer == True:
        ...
        if prompt == "n":
            TAc.print(LANG.render_feedback("error-TrueOneCall-dec2opt", "Sbagliato!"),"red")
    if answer == False:
        if prompt == "y":
