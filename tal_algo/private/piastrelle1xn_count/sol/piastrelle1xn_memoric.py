#!/usr/bin/python
"""una soluzione ricorsiva semplice, che non si preoccupa di risolvere più di un testcase, nè dei casi con n > 10^9, nè di rispettare il protocollo per il dialogo col manager della sottoposizione offerto dal servizio solve."""
