...
def TALinput(token_type, num_tokens=None, sep=None, exceptions = set({}), comment_lines_start_with='#', regex="^((\S)+)$", regex_explained=None, line_explained=None, line_recognizer=None, TAc=None, LANG=None):
