...
def TALinput(token_type, num_tokens=None, sep=None, exceptions = set({}), comment_lines_start_with='#', regex="^((\S)+)$", regex_explained=None, TAc=None):
    ...
    while True:
        ...
        if spoon in exceptions:
            return (spoon,)
        if len(spoon) == 0:
            TAc.print(f"You have entered an unexpected empty line. I assume you want to drop this TALight service call. See you next time ;))")
            exit(0)
